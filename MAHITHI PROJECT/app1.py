...
def main():
    ...
    nav = st.sidebar.selectbox("Select a page", ["Home", "About", "Agriculture", "Education", "Personal", "Marriage"])
    ...
    if nav == "Home":
        ...
        st.title("Agriculture Information")
        ...
        st.title("Education Information")
